    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-success justify-content-end">
            <div className="container-fluid">
                <a className="navbar-brand" href="#">Alicia's Profolio</a>
                    <button 
                ...
                id="navbarNavDropdown">
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <a className="nav-link active" aria-current="page" href="#">Projects Me</a>
                        </li>
                        <li className="nav-item">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a className="dropdown-item" href="#">Project 2 action</a></li>
